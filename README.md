...
- 공매도 카드는 종목별 UI에 먼저 배치하되, KRX/FINRA provider가 확인되기 전에는 거래대금·비중·잔고·대차잔고를 `미제공`으로 표시하고 합성 수치를 만들지 않음
...
| 검증 | TypeScript strict, Vitest 66개 파일·354개 테스트, SQLite/금지 endpoint 헬스체크 |
