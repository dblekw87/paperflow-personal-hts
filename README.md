...
| 투자자 수급 | 거래소 원천 KRX provider를 우선하고, 확인된 수급 endpoint 연결 전에는 KIS 실전 읽기 전용 REST fallback으로 KOSPI·KOSDAQ 개인/외국인/기관 스냅샷과 종목별 개인/외국인/기관/프로그램 매매를 투영 |
...
| 검증 | TypeScript strict, Vitest 64개 파일·349개 테스트, SQLite/금지 endpoint 헬스체크 |
