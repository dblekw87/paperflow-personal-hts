...
| 투자자 수급 | 거래소 원천 KRX 통계 CSV provider를 우선해 종목별 개인/외국인/기관 수급을 투영하고, 전체 시장 수급·프로그램매매 또는 KRX 실패 시 KIS 실전 읽기 전용 REST fallback을 사용 |
...
| 검증 | TypeScript strict, Vitest 67개 파일·360개 테스트, SQLite/금지 endpoint 헬스체크 |
...
- `[12008] 투자자별 거래실적` 전체 시장 수급과 프로그램매매는 추가 payload
  확인 후 같은 KRX 통계 다운로드 client에 연결 예정
